...
import com.polezhaiev.avtodiva.ui.panel.data.table.FreeSlotsTableModel;
...
public class FreeSlotsPanel extends JPanel {
    ...
    private TableRowSorter<FreeSlotsTableModel> sorter;
    ...
    private void setupSearchFunctionality(JTable table) {
        ...
        am.put("startSearch", new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                FreeSlotsPanel.this.revalidate();
                FreeSlotsPanel.this.repaint();
    ...
    private JButton getSearchButton() {
        ...
        searchButton.addActionListener(e -> {
            if (selectedTimes.isEmpty()) {
                refreshFreeSlots(scheduleSlotService.findFreeSlots(
                ...
                List<ScheduleSlot> freeSlots = scheduleSlotService.findFreeSlots(
                        AppState.instructorNames,
                        AppState.carNames,
                        AppState.startDate,
                        AppState.endDate
                ...
                List<ScheduleSlot> filteredFreeSlots = scheduleSlotService.filterSlotsByTime(freeSlots, selectedTimes);
                refreshFreeSlots(filteredFreeSlots);
            }
        });
        return searchButton;
    }
